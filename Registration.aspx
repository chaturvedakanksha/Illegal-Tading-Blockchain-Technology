...
&nbsp;<label for="cpsw"><b>Confirm Password <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="TextBox2" ControlToValidate="TextBox3" ErrorMessage="must be same as Password" Font-Size="Small" ForeColor="Red"></asp:CompareValidator>
...
&nbsp;<label>
                ...
                <div class="container" style="text-align:center; background-color:#f1f1f1">
                    <span class="signIn" style="text-align:center">Already have an Account ? <a href="Login.aspx">Sign In</a></span>
                     &nbsp;<asp:Button ID="Button1" runat="server" BackColor="#3399FF" Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="46px" OnClick="Button1_Click" Text="Submit" Width="574px" />
                </div>
            </form>
        </div> 
   </div>
